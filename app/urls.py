...
urlpatterns = [
    ...
    path('saveContents', views.saveContents, name='saveContents'),
    path('deleteContents', views.deleteContents, name='deleteContents'),
    path('saveChapter', views.saveChapter, name='saveChapter'),
